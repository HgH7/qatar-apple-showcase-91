      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-muted to-background py-20 md:py-32">
        <div className="section-container">
          ...
          duration: 0.6
            ...
            <Link to="/products" className="btn-hero border-0 rounded-xl">
              {t('hero.cta')}
      ...
      <section className="py-16 md:py-24">
        <div className="section-container">
          ...
          once: true
            ...
            <Link to="/products" className="inline-flex items-center gap-2 font-medium text-secondary transition-colors hover:text-secondary/80">
              {t('products.title')}
      ...
      <section className="border-t border-border bg-card py-16 md:py-24">
        <div className="section-container">
          <div className="grid gap-8 md:grid-cols-3">
            {valueProps.map((prop, index) => <motion.div key={prop.title} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
